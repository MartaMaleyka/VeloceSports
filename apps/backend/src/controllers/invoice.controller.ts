...
function pdfLabelsFromRequest(req: Request): InvoicePdfLabels {
  ...
  if (locale === 'en') {
    return {
      ...
      invoiceType: 'Type',
      invoiceTypeMonthly: 'Monthly (active players)',
      invoiceTypeAnnual: 'Annual plan fee',
      academy: 'Academy',
      plan: 'Plan',
  ...
  return {
    ...
    invoiceType: 'Tipo',
    invoiceTypeMonthly: 'Mensual (jugadores activos)',
    invoiceTypeAnnual: 'Anualidad del plan',
    academy: 'Academia',
    plan: 'Plan',
