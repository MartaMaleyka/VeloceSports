/** Decoración visual del hero de login — monocromo oscuro + lima (sin naranja/azul). */
  ...
  return (
    <>
      ...
      <div className="ds-brand-page__hero-wave" aria-hidden="true">
        <div className="ds-brand-page__hero-wave-fade" />
        <svg viewBox="0 0 120 800" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <path
            className="ds-brand-page__hero-wave-path ds-brand-page__hero-wave-path--soft"
