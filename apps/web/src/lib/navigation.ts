...
export function getNavItemsForRole(role: LoginRole, locale: Locale): NavItem[] {
  ...
  if (role === 'academy_admin') {
    return [
      { id: 'home', href: appPath('/dashboard/academy-admin'), label: t('nav.home', locale), sectionAccent: 'brand' },
      { id: 'users', href: appPath('/dashboard/academy-admin/users'), label: t('nav.users', locale), sectionAccent: 'users' },
      {
        id: 'categories',
        href: appPath('/dashboard/academy-admin/categories'),
        label: t('nav.categories', locale),
        sectionAccent: 'academies',
      },
      {
        id: 'players',
        href: appPath('/dashboard/academy-admin/players'),
        label: t('nav.players', locale),
        sectionAccent: 'plans',
      },
      { id: 'billing', href: appPath('/dashboard/academy-admin/billing'), label: t('nav.billing', locale), sectionAccent: 'billing' },
      {
        id: 'matches',
        href: appPath('/dashboard/academy-admin/matches'),
        label: t('nav.matches', locale),
        sectionAccent: 'matches',
      },
      {
        id: 'actions',
        href: appPath('/dashboard/academy-admin/actions'),
        label: t('nav.actions', locale),
        sectionAccent: 'matches',
      },
      {
        id: 'reports',
        href: appPath('/dashboard/academy-admin/reports'),
        label: t('nav.reports', locale),
        sectionAccent: 'audit',
      },
      {
        id: 'settings',
        href: appPath('/dashboard/academy-admin/settings'),
  ...
  if (role === 'parent') {
    return [
      { id: 'home', href: appPath('/dashboard/parent'), label: t('nav.home', locale), sectionAccent: 'brand' },
      {
        id: 'calendar',
